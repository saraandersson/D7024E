...
func main() {
	...
	var contact d7024e.Contact
       ...
       /**/
        ...
        kademliaNetwork.LookUpContact(rtContact1, 8002)
        kademliaNetwork.LookUpContact(rtContact2, 8002)
        kademliaNetwork.LookUpContact(rtContact3, 8002)
        kademliaNetwork.LookUpContact(rtContact4, 8002)
        kademliaNetwork.LookUpContact(rtContact5, 8002)
       /**/
